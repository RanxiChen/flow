#!/usr/bin/env python3
"""Build and run bounded Linux-profile CLINT MSIP/MTIP smoke tests."""
...
def main():
    ...
    parser.add_argument("--mem-trace-max-events", type=int, default=96)
    ...
    command = [
        ...
        "--non-interactive",
        "--mem-trace",
        "--mem-trace-address-start", "0x02000000",
        "--mem-trace-address-end", "0x02010000",
